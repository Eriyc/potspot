...
import {useLocation} from '@/hooks/traps';
...
export const PickLocationMap: FC<PickLocationMapProps> = ({
  ...
  const iconStyle = tw('text-gray-500 text-gray-100');
    ...
    <Fragment>
      <View style={tw('relative')}>
        ...
        <Pressable
          ...
          style={tw(
            'bg-gray-200 rounded-md p-2 top-1 right-1 absolute dark:bg-gray-700 dark:active:bg-gray-500',
          )}>
      ...
      {locationGranted && (
        <Pressable
          ...
          onPress={moveToUser}
          style={tw(
            'bg-gray-200 my-2 p-2 rounded-sm flex flex-row items-center justify-center dark:bg-gray-700',
          )}>
          <Navigation style={tw('text-gray-500 mr-2 dark:text-gray-100')} />
